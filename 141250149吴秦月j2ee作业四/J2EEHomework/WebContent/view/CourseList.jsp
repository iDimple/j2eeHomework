...
<body>
	...
	<br>
	<jsp:useBean id="courseList" type="model.CourseList" scope="session"></jsp:useBean>
	<%!String a = "";
	String url = "";%>
	<%
		for (int i = 0; i < courseList.getCourseList().size(); i++) {
			...
			url = "/J2EEHomework/ShowResults?cid=" + a;
	%>
	<a href=<%=url%>> <%=a%>
	</a>
	...
	%>
	<form method="GET" action="/J2EEHomework/view/Login.jsp">

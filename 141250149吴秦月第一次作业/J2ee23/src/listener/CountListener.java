...
HttpSessionListener, HttpSessionAttributeListener {
	...
	// private String counterFilePath = "D:/counter.txt";
	...
	public void attributeAdded(HttpSessionBindingEvent se) {
		// TODO Auto-generated method stub
		if (LoginSession.logInSessionName.equals(se.getName())) {
			HttpSession session = se.getSession();
			logIn(session);
		}
	}
	...
	public synchronized void sessionInvalid(HttpSession session) {
		ServletContext servletContext = session.getServletContext();
		if (session.getAttribute(LoginSession.logInSessionName) != null) {
			onlineCounter--;
